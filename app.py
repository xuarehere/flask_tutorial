...
# from werkzeug.security import generate_password_hash, check_password_hash   # 用来为给定的密码生成密码散列值, 以及检查散列值是否对应密码
# from flask_login import LoginManager  # 实现用户认证需要的各类功能函数
...
#
#     user = User.query.first()
#     if user is not None:        # 已存在，则更新相关信息
